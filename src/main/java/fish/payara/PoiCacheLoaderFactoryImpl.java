...
@ApplicationScoped
public class PoiCacheLoaderFactoryImpl
		implements CacheLoader<Integer, PointsOfInterestResponse>, CacheWriter<Integer, PointsOfInterestResponse> {
	...
	@Override
	public Map<Integer, PointsOfInterestResponse> loadAll(Iterable<? extends Integer> keys)
	...
	@Override
	@Transactional
	public void write(Cache.Entry<? extends Integer, ? extends PointsOfInterestResponse> entry)
	...
	@Override
	@Transactional
	public void writeAll(Collection<Cache.Entry<? extends Integer, ? extends PointsOfInterestResponse>> entries)
			throws CacheWriterException {
		entries.forEach(e -> {
